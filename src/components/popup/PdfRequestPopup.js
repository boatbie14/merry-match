    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            <div className="w-full md:max-w-[1246px] md:px-7 mt-1 mb-6">
                ...
                <div className="divide-y divide-[#E4E4EB] border-t-1 border-[#E4E6ED] font-semibold md:pt-2 md:border-0 md:pb-2">
                  {billingData.map((item, index) => (
                    ...
                    >
                      ...
                      <span className="text-[14px] md:text-[16px] flex-[1] text-left">
              ...
              <div className="flex px-4 w-full justify-between">
                <div>
                  <span className={`hidden md:block ${selectedInvoices.length === 10 ? "text-[#f6270c]" : "text-[#abaeb7]"} ml-6 mt-2 `}>
                ...
                <div className="flex pt-4 justify-end gap-5 border-t border-[#E4E4EB] md:border-0">
                  <button
                    ...
                    className="primary-btn rounded-2xl cursor-pointer"
                  >
                    Request PDF
                  </button>
                  <button
          ...
          <span className={`md:hidden ${selectedInvoices.length === 10 ? "text-[#a01a08]" : "text-[#ffffff]"} mt-2 px-3 `}>
            {selectedInvoices.length}/10{" "}
          </span>
          <span className="text-[#ffffff] text-[12px] md:text-[16px] px-3">
            {selectedInvoices.length > 1 && " Turn off pop-up blocked if there are more than 1 files."}
          </span>
        </motion.div>
      )}
    </AnimatePresence>
