...
export default function Chat() {
  // Mock user IDs สำหรับการทดสอบ (สลับ ID จากไฟล์ index.js)
  const sender_id = "04d3a1ca-03c6-494b-8aa8-d13c2f93325a";
  const receiver_id = "8ad64c2c-16f7-4e49-be91-a6da370d40db";
  const username = "AI 778"; // เพิ่ม username ตามที่คุณต้องการ
