  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const { data: result } = await supabase
        .from("user_packages")
        .select(
          "start_date, end_date, packages(package_name, price, merry_per_day, description, icon_url)"
        )
        ...
        <div className="w-full md:w-1/2 flex flex-col-reverse items-center md:items-end gap-10">
          ...
          <div className="bg-gradient-to-br from-[#742138] to-[#A878BF] text-white p-6 rounded-2xl shadow-md w-full max-w-sm">
            ...
            <div className="text-start">
              <div className="space-y-4 pb-9 font-normal">
                <div className="flex gap-3 items-center">
                  <div className="relative w-4 h-4">
                    ...
                    <Image
                      ...
                      alt="Success Icon"
                      fill
                      className="object-contain saturate-200 brightness-90"
                    />
                  </div>
                ...
                <div className="flex gap-3 items-center">
                  ...
                  Up to {data.packages.merry_per_day} Merry per day
                </div>
              </div>
            </div>
