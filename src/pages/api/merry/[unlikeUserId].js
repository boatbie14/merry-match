...
import { deleteMerryLike, getMerryLike, updateChatRoomMatchStatus } from "@/utils/query/merryLike";
export default async function handler(req, res) {
  ...
  try {
    ...
    // อัพเดต chat_rooms is_match เป็น false
    await updateChatRoomMatchStatus(userId, toUserId, false);
