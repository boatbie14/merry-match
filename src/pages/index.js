...
const HomePage = () => {
  ...
  return (
    <div className=" flex  justify-center items-center bg-[#160404] z-20 ">
      <div className="m-auto w-full max-w-[1440px] ">
        <section className="navMarginTop md:h-[758px] overflow-hidden mt-12 pt-80 md:pt-44 pb-20 bg-[#160404] ">
          <div className="container mx-auto px-6 relative">
            ...
            <div className="flex flex-col  items-center justify-center text-center ">
              <div className="max-w-xl w-[358px] relative z-10">
                <h1 className="makeTheFirstMarry text-6xl font-black text-white leading-tight mb-6">
                  Make the <br />
                  first &apos;Merry&apos;
                </h1>
                <p className="ifYouFeel text-xl text-white mb-12">
                  If you feel lonely, let&apos;s start meeting <br /> new people
                  in your area! <br />
              ...
              <div className="Hero-profile relative w-1/2 h-[600px]  ">
                <div>
                  ...
                  <div className="niceTMY absolute bottom-[980px] right-[190px] w-[160px] md:bottom-[820px] md:right-[-275px] bg-[#64001D] text-white p-3 rounded-[24px_24px_24px_0px] text-sm font-semibold">
                    Hi! Nice to meet you
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <div className="niceTMYtoo absolute flex flex-row w-[180px] bottom-[-180px] left-[170px] md:bottom-[150px] md:left-[-230px] bg-[#64001D] text-white p-3 rounded-[24px_24px_0px_24px] text-sm font-semibold">
                      <svg
                        className="mr-2"
                        width="10"
                        height="10"
        ...
        <section
          id="WhyMerryMatch"
          className="  m-auto md:py-20 bg-[#160404]  "
        >
          <div className="container flex  md:flex-row m-auto mx-auto px-6">
            <div className="flex flex-col xl:flex-row  lg:flex-col items-center justify-center w-full">
              ...
              <div className="merry-match-card flex px-0 lg:ml-40 xl:ml-20 md:px-auto lg:pt-20 pt-32 m-auto w-1/2  ">
                <div className="relative h-[324px] z-20 ">
                  {/* fast box */}
                  <div className="absolute top-0 left-[-49px] sm:left-[70px] w-[149px] h-[63px] sm:w-[237px] sm:h-[99px] bg-[#7D2262] rounded-[18px] drop-shadow-2xl z-30 p-6">
                    <div className="flex items-center gap-2 text-white">
                      <div className="arrow-sm hidden sm:flex w-5 h-5 rounded">
                        <svg
                          width="19"
                          height="17"
                          viewBox="0 0 19 17"
                      ...
                      <div className="arrow-LowerSM sm:hidden w-5 h-5 rounded absolute top-[20px]">
                        <svg
                          width="10"
                          height="10"
                          viewBox="0 0 19 17"
                      ...
                      <span className="fast-BiggerSM hidden sm:flex sm:text-xl font-bold ">
                        Fast
                      </span>
                      <span className="fast-lowerSM sm:hidden absolute text-sm font-bold top-[16px] left-[40px] ">
                        Fast
                      </span>

                      <div className="relative">
                        {/* sm picture resolution */}
                        <svg
                          className="hidden sm:flex absolute top-[-37px] left-[40px] opacity-50 "
                          width="97"
                          height="76"
                          viewBox="0 0 97 76"
                          fill="none"
                        ...
                        {/* < sm picture resolution */}
                        <svg
                          className="arrowBig sm:hidden absolute top-[-24px] left-[65px] opacity-50 "
                          width="58"
                          height="57"
                          viewBox="0 0 97 76"
                          fill="none"
                  ...
                  {/* Secure box sm */}
                  <div className="hidden absolute top-[87px] left-0 w-[398px] h-[109px] bg-[#DF89C6] rounded-[18px] p-6 sm:flex items-center z-20 ">
                    <div className="flex items-center gap-2 text-[#7D2262] ">
                      <div className="SVG-secure relative mr-60  ">
                        <svg
                          className=" absolute top-[-27px] left-[20px] opacity-70"
                          width="98"
                          height="82"
                          viewBox="0 0 98 82"
                          fill="none"
                  ...
                  {/* boy picture sm */}
                  <div className=" hidden sm:flex absolute bg-amber-300 w-[60px] h-[60px] rounded-full top-[42px] left-[375px] z-10 ">
                    <Image
                      src="/images/boy.png"
                      alt="boy"
                      width={60}
                      height={60}
                      className="  w-[60px] h-[60px] rounded-full object-cover object-center-bottom grayscale "
                    />
                  </div>

                  {/* Secure box < sm */}
                  <div className="sm:hidden absolute top-[57px] left-[-85px] w-[250px] h-[68px] bg-[#DF89C6] rounded-[18px] p-6 flex items-center z-20">
                    <div className="flex items-center gap-2 text-[#7D2262]  ">
                      <div className="SVG-secure relative mr-60  ">
                        <svg
                          className=" absolute top-[-29px] left-[-10px] opacity-70 "
                          width="61"
                          height="63"
                          viewBox="0 0 98 82"
                          fill="none"
                      ...
                      <div className="w-5 h-5 rounded absolute top-[20px] right-[70px]">
                        <svg
                          width="16"
                          height="18"
                          viewBox="0 0 16 18"
                      ...
                      <span className="text-sm font-bold absolute top-[20px] right-[25px]">
                        Secure
                      </span>
                      <div className="relative  ">
                        <div className="absolute w-2.5 h-2.5 bg-[#612F16] rounded-full left-[16px] bottom-[70px] "></div>
                      </div>
                    </div>
                  </div>
                  {/* boy picture < sm */}
                  <div className=" sm:hidden absolute bg-amber-300 w-[38px] h-[38px] rounded-full top-[30px] left-[145px] z-10 ">
                    <Image
                      src="/images/boy.png"
                      alt="boy"
                      width={38}
                      height={38}
                      className="w-[38px] h-[38px] rounded-full object-cover object-center-bottom grayscale "
                    />
                  </div>
                  {/* easy box sm */}
                  <div className="hidden absolute top-[178px] left-[171px] w-[328px] h-[146px] bg-[#EFC4E2] drop-shadow-2xl rounded-[29px] p-6 sm:flex items-end">
                    <div className="flex flex-row gap-2 text-end   text-[#C70039]">
                      ...
                      <div className="relative">
                        ...
                        <svg
                          className="absolute top-[-71px] left-[103px] opacity-50 "
                          width="122"
                          height="123"
                          viewBox="0 0 122 123"
                          fill="none"
                  ...
                  {/* easy box < sm */}
                  <div className="sm:hidden absolute top-[115px] left-[17px] w-[206px] h-[92px] bg-[#EFC4E2] drop-shadow-2xl rounded-[18px] p-6 flex items-end z-20">
                    <div className="flex flex-row gap-2 text-end   text-[#C70039]">
                      <div className="w-5 h-5 rounded pt-1.5 absolute top-[51px] left-[15px]">
                        <svg
                          width="14"
                          height="14"
                          viewBox="0 0 19 18"
                      ...
                      <span className="text-sm font-bold absolute top-[55px] left-[35px] ">
                        Easy
                      </span>
                      <div className="relative">
                        <div className="absolute w-1.5 h-1.5 rounded-full bg-[#CF4FA9] right-[120px] top-[-2px]"></div>
                        <svg
                          className="starSM absolute top-[-55px] left-[100px] opacity-50"
                          width="82"
                          height="79"
                          viewBox="0 0 122 123"
                          fill="none"
                        ...
                        <div className="absolute top-[-25px] right-[45px] w-[60px] h-[60px] bg-amber-950  rounded-full ">
                          <Image
                            src="/images/girl.jpg"
                            alt="girl"
                            width={100}
                            height={100}
                            className="  w-[60px] h-[60px] rounded-full object-cover object-center grayscale"
                          />
                        </div>
                      </div>
                    </div>
        ...
        {/* CTA Section */}
        <section className="ctaSection1 py-0  md:py-20 bg-[#160404] ">
          <div className="ctaSection2 mx-auto xl:px-28 ">
            <div className="ctaSection3 flex relative justify-center items-center md:rounded-[32px] overflow-hidden bg-gradient-to-r from-[#820025] to-[#A95BCD] h-[564px] md:h-[369px]   ">
              {/* heart decoration*/}
              <div className="CTAVector1"> <Image src="/images/CTA Vector1.png" alt="CTAVector1" width={151} height={140} className="absolute left-[1px] top-[30px]" /> </div>
              <div className="CTAVector2" > <Image src="/images/CTA Vector2.png" alt="CTAVector2" width={77} height={71} className="absolute right-[1px] bottom-[25px]" /></div>
              <div className="CTAVector3" > <Image src="/images/CTA Vector3.png" alt="CTAVector3" width={25} height={23} className="absolute right-[80px] bottom-[130px]" /></div>


              <div className=" px-12 flex-col justify-center items-center text-center relative ">
                <h2 className="text-5xl font-extrabold text-white mb-14 relative z-10">
